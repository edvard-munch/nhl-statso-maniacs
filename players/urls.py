...
urlpatterns = [
    ...
    path('game/<slug>/<int:nhl_id>/', views.game_detail,
         name='game_detail'),
    path('ajax_players/<str:stat_type>/<str:page>/<str:size>/<str:sort_col>/<str:filt_col>/<str:rookie_filt>/',
         views.ajax_players, name='ajax_players'),
    path('ajax_players/<str:stat_type>/<str:page>/<str:size>/<str:sort_col>/<str:filt_col>/<str:rookie_filt>/<str:fav_filt>/',
         views.ajax_players, name='ajax_players'),
