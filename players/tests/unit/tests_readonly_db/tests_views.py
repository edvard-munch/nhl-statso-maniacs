...
@pytest.mark.parametrize(
    ...
    [
        ...
        [
            "ajax_players",
            ("gls", "page=1", "size=25", "col", "fcol", "rookie_filter=", "checkbox_filter="),
        ],
        [
            "ajax_players",
            ("tot", "page=3", "size=100", "col", "fcol", "rookie_filter=", "checkbox_filter="),
        ],
        [
            "ajax_players",
            (
        ...
        [
            "ajax_players",
            ("avg", "page=3", "size=100", "col", "fcol", "rookie_filter=", "checkbox_filter="),
        ],
        [
            "ajax_players",
            (
