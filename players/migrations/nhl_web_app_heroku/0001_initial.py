    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        storage=players.storage.OverwriteStorage(),
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="compare_g", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "favorite",
                    models.ManyToManyField(
                        blank=True, related_name="favorite_g", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    django.contrib.postgres.fields.ArrayField(
                        base_field=models.CharField(blank=True, max_length=5),
                        blank=True,
                        default=list,
                        size=None,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "compare",
                    models.ManyToManyField(
                        blank=True, related_name="compare_s", to=settings.AUTH_USER_MODEL
                    ),
                ),
                (
                    "favorite",
                    models.ManyToManyField(
                        blank=True, related_name="favorite_s", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        storage=players.storage.OverwriteStorage(), upload_to="teams_logos"
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, to="players.Team"
            ),
        ),
        migrations.AddField(
            model_name="goalie",
