...
def import_player(data, player):
    ...
    for season in data:
        if season["league"]["name"] == NHL:
            ...
            if player.position_abbr in POSITIONS[1:]:
                ...
                season["stat"]["timeOnIce"] = time_from_sec(
                    time_to_sec(season["stat"]["timeOnIce"]) / season["stat"]["games"]
                )

                season["stat"]["powerPlayTimeOnIce"] = time_from_sec(
                    time_to_sec(season["stat"]["powerPlayTimeOnIce"]) / season["stat"]["games"]
                )

                season["stat"]["shortHandedTimeOnIce"] = time_from_sec(
                    time_to_sec(season["stat"]["shortHandedTimeOnIce"]) / season["stat"]["games"]
                )
    ...
    if player.position_abbr == POSITIONS[0]:
        ...
        for season in nhl_seasons_avg:
            season["stat"]["goals"] = round(season["stat"]["goals"] / season["stat"]["games"], 2)
            season["stat"]["assists"] = round(
                season["stat"]["assists"] / season["stat"]["games"], 2
            )
            season["stat"]["points"] = round(season["stat"]["goals"] + season["stat"]["assists"], 2)
            season["stat"]["plusMinus"] = round(
                season["stat"]["plusMinus"] / season["stat"]["games"], 2
            )
            season["stat"]["hits"] = round(season["stat"]["hits"] / season["stat"]["games"], 2)
            season["stat"]["shots"] = round(season["stat"]["shots"] / season["stat"]["games"], 2)
            season["stat"]["blocked"] = round(
                season["stat"]["blocked"] / season["stat"]["games"], 2
            )
            season["stat"]["pim"] = round(season["stat"]["pim"] / season["stat"]["games"], 2)
            season["stat"]["powerPlayPoints"] = round(
                season["stat"]["powerPlayPoints"] / season["stat"]["games"], 2
            )
            season["stat"]["shortHandedPoints"] = round(
                season["stat"]["shortHandedPoints"] / season["stat"]["games"], 2
            )
            ...
            player.save(
                update_fields=["sbs_stats", "sbs_stats_avg", "multiteams_seasons", "nhl_debut"]
            )
